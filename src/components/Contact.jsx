...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-full bg-[#0a192f] flex justify-center items-center pt-24'>
      <form action="" className='flex flex-col max-w-[800px] w-full text-black '>
        <div className='p-8'>
          ...
          <p className='text-gray-300 py-4'>Submit the form below or send me an email -sunil01090@gmail.com</p>
        </div>
