...
const Skills = () => {
  return (
    <div name='skills' className=' text-[#36454F] bg-[#fff9cd] h-screen pt-36'>
      <div className='max-w-[1080px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className='w-full grid grid-cols-1 sm:grid-cols-2 gap-10 text-center py-8'>
          ...
          <div className='shadow-md shadow-slate-800 hover:scale-110 duration-200 hover:cursor-pointer'>
            <img className='w-[40px] mx-auto pt-2' src={JavaScript} alt="" />
          ...
          <div className='shadow-md shadow-slate-800 hover:scale-110 duration-200 hover:cursor-pointer'>
            <img className='w-[40px] mx-auto' src={bootstrap} alt="" />
